...
async function fetchData() {
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbw8Z5qI-yDdjCP--XyDa5aeMzKxPCAL5j0jFDyeAnS5ZESZOsPaoKxrbqPEaTebXwN7Aw/exec'); // Replace this with your actual web app URL
